            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                >
                    <motion.div
                        ...
                        whileHover={{ scale: 1.02, backgroundColor: "rgba(255, 136, 102, 0.2)" }}
                        ...
                        >
                            <div className="relative overflow-hidden">
                                <img
                                    ...
                                    loading="lazy"
                                />
                                <div className="absolute inset-0 bg-gradient-to-t from-primary/80 via-primary/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                            </div>
                            ...
                            <div className="block md:hidden p-4 bg-card">
                                ...
                                <motion.button
                                    className="w-full bg-accent text-accent-foreground px-4 py-2 rounded-xl font-semibold shadow-lg text-sm active:scale-95"
                                    whileTap={{ scale: 0.98 }}
                            ...
                            <div className="hidden md:flex absolute inset-0 items-center justify-center bg-primary/55 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-200">
                                <div className="text-center text-primary-foreground p-4 sm:p-6 transform translate-y-3 group-hover:translate-y-0 transition-transform duration-200">
